    ...
    <div className="panel">
      <div className="panel-inner">
        ...
        <p className="copy" style={{ marginTop: 10 }}>
          This panel combines current tracked offers across the covered European retailer layer so you can compare price, availability and market reference points in one place.
        </p>

        <div className="note" style={{ marginTop: 18 }}>
          <strong>Coverage:</strong> {offers.length} tracked retailers. <strong>Checked:</strong> {checkedAt}. {cacheTtl ? <><strong>Refresh cadence:</strong> up to every {cacheTtl} hours for this product layer.</> : null}
        </div>
