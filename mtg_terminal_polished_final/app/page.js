        ...
        <div className="container panel">
          <div className="panel-inner">
            <SectionHeading
              ...
              intro="Signals combine multi-store price velocity, availability compression, product lifecycle context, serialized impact and confidence grading. This is snapshot-based intelligence, not noisy live scraping every time a page loads."
            />
